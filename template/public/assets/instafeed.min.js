            ...
            if (this.options.display_gallery) {
                ...
                if (typeof data.is_private !== "undefined" && data.is_private === true) {
                    ...
                    for (var i = 0; i < max; i++) {
                        ...
                        html += "<a  href='" + url + (this.options.display_captions? "' data-caption='" + caption : "") + "' class='col-6 col-sm-2 instagram-" + type_resource + "' rel='noopener' target='_blank'" + styles.gallery_image_link + ">";
